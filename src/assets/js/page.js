...
$(function () {
    // landingOptions.tooltip();
    landingOptions.scrollToSections();
    // landingOptions.headerHamburgerCollapse();
    landingOptions.controlLenght();
    landingOptions.currency();
    // landingOptions.carousel();


    $(document).on("click", ".Navigation_c-nav-toggle_3tn8u", function () {
        $(".Navigation_c-nav-container_1git3").toggleClass("Navigation_is-visible_2o2sb");
...
// Add an event listener for form submission
    ...
    // $('#restart_calculator').click(function(){
    //     $('#result').addClass('hidden');
    //     $('html, body').animate({
    //         scrollTop: $('#first-form').offset().top
    //     }, 1000);
    // });
    ...
    $(document).ready(function() {
        ...
        function formatOption(option) {
            ...
            const flags = {
                gb: "./assets/images/flags/uk.svg", // UK
                eu: "./assets/images/flags/eu.svg", // EU
                us: "./assets/images/flags/usa.svg", // USA
            };
            ...
            return $(`<span class="flex gap-4 p-2 text-sm lg:text-base items-center">${flagIcons} ${option.text}</span>`);
        }
    });
        ...
        "columns": [

            {
                ...
                render: {
                    ...
                    display: function (data, type, row) {
                        return '<span data-toggle="tooltip" data-rank="' + data.rank + '" data-placement="bottom"  class="td-simulate tooltip rank " data-tooltip="Rank"><span class="">' + data.rank + '</span></span>';
                    }
                }
            },
            {
                ...
                render: {
                    ...
                    display: function (data, type, row) {
                        return '<span data-toggle="tooltip" data-placement="bottom" class="td-simulate tooltip font-weight-bold text-left pl-3 items-center gap-4" data-tooltip="Country" style="display: flex !important;">' +
                            '<img class="table-img lazy" src="./assets/images/flags/' + data.country.toLowerCase().replace(/ /g, '-') + '.svg" alt="">' +
            ...
            },
            {
                ...
                render: {
                    ...
                    display: function (data, type, row) {
                        return '<span data-toggle="tooltip" data-placement="bottom" class="td-simulate tooltip px-3" data-tooltip="Estimated hourly rate (£) ">' + (data.rstimated_hourly_rate) + '</span>';
                    }
                }
            },
            {
                ...
                render: {
                    ...
                    display: function (data, type, row) {
                        return '<span data-toggle="tooltip" data-placement="bottom" class="td-simulate tooltip px-3" data-tooltip="Annual number of hours needed to work to earn UK salary">' + (data.hours_uk) + '</span>';
                    }
                }
            },
            {
                ...
                render: {
                    ...
                    display: function (data, type, row) {
                        return `<span data-toggle="tooltip" data-placement="bottom" class="td-simulate tooltip px-3 ${
                                data.difference_to_uk < 0 ? '!text-[#B3C066]' : '!text-[#E97657]'
...
function abbreviateNumber(number) {
    ...
    if (number >= 1000) {
        return (numberWithCommas(number)) + ' lbs';
    }
